...
const Manager = () => {
    ...
    // db se pass fetch hoge ab localstorage se nhi
...
// making copyText , used in lordicon and here toastify is used to show
    ...
    return (
        <>
        {/* kahi bhi lga skte h but its better to put inside ogreturn  */}
            <ToastContainer
                position="top-right"
                autoClose={5000}
                hideProgressBar={false}
            ...
            <div className=" p-3 md:mycontainer min-h-[83vh] ">
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <button onClick={savePassword} className='flex justify-center items-center gap-2 bg-green-400 hover:bg-gray-500 rounded-full px-8 py-2 w-fit border border-blue-300'>
                        <lord-icon
